                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="card rounded-0">
                        <div class="card-header">
                            <h3 class="mb-0">Genera sabanas masivas por placa: <i class="animate__animated animate__fadeInLeft animate__delay-1s  far fa-list"></i> </h3>
...
<script>
    ...
    function consumeajax() {
        ...
        $.ajax({
            ...
            url: "{{url('sabanas/sabanas-masivas_2')}}",
            type: "post",
            processData: false,
            contentType: false,
            data: formData,
