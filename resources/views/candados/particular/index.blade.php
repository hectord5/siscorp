...
@section('title', 'Candados Particular')

@section('content_header')
    <h1 class="text-bold">CANDADOS: PARTICULAR</h1>
@endsection
                    ...
                    <div id="collapseOne" class="panel-collapse active">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group d-flex justify-content-center">
                                            <button type="button" class="btn btn-primary " id="bt-pt-search">BUSCAR   <i class="fas fa-search"></i></button>
                            ...
                            <div class="d-flex justify-content-center">
                                <btn data-toggle="collapse" data-parent="#accordion"  id="accordionloadlist" href="#collapseTwo" class="btn btn-primary">
                                    ACTIVAR CANDADO
                                </btn>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        ...
                        <div class="card-footer">
                            <div class="form-group">
                                <button type="button" class="btn btn-primary btn-block" id="bt-pt-alta">ACEPTAR</button>
                            </div>
                        </div>
                    </div>
                </div>
