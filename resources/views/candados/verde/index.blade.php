...
@section('title', 'Candados Verde')

@section('content_header')
    <h1 class="text-bold">CANDADOS: VERDE</h1>
@endsection
            ...
            <div id="accordion">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-outline-success btn-block" id="bt-pt-search">BUSCAR</button>
                ...
                <div class="card">
                    <div class="card-header">
                        <btn data-toggle="collapse" data-parent="#accordion"  id="accordionloadlist" href="#collapseTwo" class="btn btn-outline-success btn-block">
                            ACTIVAR CANDADO
                        </btn>
                    </div>
                    <div id="collapseTwo" class="panel-collapse collapse">
                        ...
                        <div class="card-footer">
                            <div class="form-group">
                                <button type="button" class="btn btn-outline-success btn-block" id="bt-pt-alta">ACEPTAR</button>
                            </div>
                        </div>
                    </div>
                </div>
