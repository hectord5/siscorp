...
@section('title', 'Candados Discapacitados')

@section('content_header')
    <h1 class="text-bold">CANDADOS: DISCAPACITADOS</h1>
@endsection
            ...
            <div id="accordion">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-secondary btn-block" id="bt-pt-search">BUSCAR</button>
                ...
                <div class="card">
                    <div class="card-header">
                        <btn data-toggle="collapse" data-parent="#accordion"  id="accordionloadlist" href="#collapseTwo" class="btn bg-gradient-primary btn-block">
                            ACTIVAR CANDADO
                        </btn>
                    </div>
