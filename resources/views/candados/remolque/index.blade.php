...
@section('title', 'Candados Remolque')

@section('content_header')
    <h1 class="text-bold">CANDADOS: REMOLQUE</h1>
@endsection
            ...
            <div id="accordion">
                <div class="card">
                    <div class="card-header bg-warning">
                        <h3 class="text-center text-bold text-white">CANDADOS ACTIVOS</h3>
                    </div>
                    <div id="collapseOne" class="panel-collapse active">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="searchplaca" id="searchplaca" class="text-uppercase form-control" placeholder="Placa" required>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="searchserievh" id="searchserievh" class="text-uppercase form-control" placeholder="Serie Vehicular" required>
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <br>
                                    ...
                                    <div class="col">
                                        <div class="form-group d-flex justify-content-center">
                                            <button type="button" class="btn btn-secondary" id="bt-pt-search">BUSCAR <i class="fas fa-search"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-footer">
                            <div class="card-body">
                                <btn data-toggle="collapse" data-parent="#accordion"  id="accordionloadlist" href="#collapseTwo" class="btn bg-gradient-warning text-white d-flex justify-content-center">
                                        CLICK PARA ACTIVAR CANDADO
                                </btn>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        ...
                        <div class="card-footer">
                            <div class="form-group d-flex justify-content-center">
                                <button type="button" class="btn btn-secondary " id="bt-pt-alta">ACEPTAR</button>
                            </div>
                        </div>
                    </div>
                </div>
