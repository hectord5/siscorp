...
@section('title', 'Candados Escolta')

@section('content_header')
    <h1 class="text-bold">CANDADOS: ESCOLTA</h1>
@endsection
            ...
            <div id="accordion">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary btn-block" id="bt-pt-search">BUSCAR</button>
                ...
                <div class="card">
                    <div class="card-header">
                        <btn data-toggle="collapse" data-parent="#accordion"  id="accordionloadlist" href="#collapseTwo" class="btn bg-gradient-dark btn-block">
                            ACTIVAR CANDADO
                        </btn>
                    </div>
