...
@section('title', 'Candados Moto')

@section('content_header')
    <h1 class="text-bold">CANDADOS: MOTO</h1>
@endsection
            ...
            <div id="accordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <btn data-toggle="collapse" data-parent="#accordion"  id="accordionloadlist" href="#collapseTwo" class="btn bg-gradient-info btn-block">
                            ACTIVAR CANDADO
                        </btn>
                    </div>
