...
@section('title', 'Candados Ruta')

@section('content_header')
    <h1 class="text-bold">CANDADOS: RUTA</h1>
@endsection
            ...
            <div id="accordion">
                ...
                <div class="card">
                    <div class="card-header">
                        <btn data-toggle="collapse" data-parent="#accordion"  id="accordionloadlist" href="#collapseTwo" class="btn bg-gradient-orange btn-block">
                            ACTIVAR CANDADO
                        </btn>
                    </div>
