...
class AntiguoSabanaController extends Controller
{
    public function seleccionaEmpresa($tipo_control){
        return view('sabanas.Empresa.busca')->with('tipo_control',$tipo_control)->with('ruta','sabanas.buscar.empresa.antiguo');
    }
    ...
    public function buscaPorEmpresa(Request $request, SicoveApiConsume $sicove){
        ...
        if( !$respuesta || (isset($respuesta['data']) && $respuesta['data'] == false) ){
            return view('sabanas.Empresa.busca')->with('tipo_control',$request->tipo_control)->with('ruta','sabanas.buscar.empresa.antiguo')
    ...
    public function seleccionaCiudadano($tipo_control){
        return view('sabanas.Ciudadano.busca')->with('tipo_control',$tipo_control)->with('ruta','sabanas.buscar.ciudadano.antiguo');
    }
    ...
    public function buscaPorCiudadano(Request $request, SicoveApiConsume $sicove){
        ...
        if( !$respuesta || (isset($respuesta['data']) && $respuesta['data'] == false) ){
            return view('sabanas.Ciudadano.busca')->with('tipo_control',$request->tipo_control)->with('ruta','sabanas.buscar.ciudadano.antiguo')
                ->withErrors('No se encontraron resultados con los parametros de busqueda');
        }
        $controles = $sicove->getListaControles();
        $res = $this->filtroActivas($respuesta['data']);
    ...
    public function seleccionaVehiculo($tipo_control){
        return view('sabanas.Vehiculo.busca')->with('tipo_control',$tipo_control)->with('ruta','sabanas.buscar.vehiculo.antiguo');
    }
    ...
    public function buscaPorVehiculo(Request $request, SicoveApiConsume $sicove){
        ...
        if( !$respuesta || (isset($respuesta['data']) && $respuesta['data'] == false) ){
            return view('sabanas.Vehiculo.busca')->with('tipo_control',$request->tipo_control)->with('ruta','sabanas.buscar.vehiculo.antiguo')
                ->withErrors('No se encontraron resultados con los parametros de busqueda');
        }
        $controles = $sicove->getListaControles();
        $res = $this->filtroActivas($respuesta['data']);
