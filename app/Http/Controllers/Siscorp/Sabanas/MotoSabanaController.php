...
class MotoSabanaController extends Controller
{
    public function seleccionaEmpresa($tipo_control){
        return view('sabanas.Empresa.busca')->with('tipo_control',$tipo_control)->with('ruta','sabanas.buscar.empresa.moto');
    }
    ...
    public function buscaPorEmpresa(Request $request, SicoveApiConsume $sicove){
        ...
        if( !$respuesta || (isset($respuesta['data']) && $respuesta['data'] == false) ){
            return view('sabanas.Empresa.busca')->with('tipo_control',$request->tipo_control)->with('ruta','sabanas.buscar.empresa.moto')
    ...
    public function seleccionaCiudadano($tipo_control){
        return view('sabanas.Ciudadano.busca')->with('tipo_control',$tipo_control)->with('ruta','sabanas.buscar.ciudadano.moto');
    }
    ...
    public function buscaPorCiudadano(Request $request, SicoveApiConsume $sicove){
        ...
        if( !$respuesta || (isset($respuesta['data']) && $respuesta['data'] == false) ){
            return view('sabanas.Ciudadano.busca')->with('tipo_control',$request->tipo_control)->with('ruta','sabanas.buscar.ciudadano.moto')
                ->withErrors('No se encontraron resultados con los parametros de busqueda');
        }
        $controles = $sicove->getListaControles();
        $res = $this->filtroActivas($respuesta['data']);
    ...
    public function seleccionaVehiculo($tipo_control){
        return view('sabanas.Vehiculo.busca')->with('tipo_control',$tipo_control)->with('ruta','sabanas.buscar.vehiculo.moto');
    }
    ...
    public function buscaPorVehiculo(Request $request, SicoveApiConsume $sicove){
        ...
        if( !$respuesta || (isset($respuesta['data']) && $respuesta['data'] == false) ){
            return view('sabanas.Vehiculo.busca')->with('tipo_control',$request->tipo_control)->with('ruta','sabanas.buscar.vehiculo.moto')
                ->withErrors('No se encontraron resultados con los parametros de busqueda');
        }
        $controles = $sicove->getListaControles();
        $res = $this->filtroActivas($respuesta['data']);
