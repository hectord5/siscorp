...
namespace App\Http\Controllers\Siscorp\Candados\Discapacitados;
...
class CandadosDiscapacitadosController extends Controller
{
    public function indexDisca(){
        return view('candados.disca.index');
    }
    ...
    public function setDownCandadoDisca(Request $request,CandadosApiConsume $candados){
    ...
    public function setCandadoDisca(Request $request,CandadosApiConsume $candados){
        $request['control'] = self::CONTROL_PARTICULAR;
    ...
    public function getCandadosDisca(Request $request,CandadosApiConsume $candados){
        $request['control'] = self::CONTROL_PARTICULAR;
